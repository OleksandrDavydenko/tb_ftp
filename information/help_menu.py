...
async def show_help_menu(update: Update, context: CallbackContext) -> None:
    ...
    idea_bounty_button = KeyboardButton("💡 Нові ідеї")
    bug_bounty_button = KeyboardButton("🐞 Bug Bounty")
    main_menu_button = KeyboardButton("Головне меню")

    reply_markup = ReplyKeyboardMarkup(
        [[currency_button, devaluation_button], [guide_button, changelog_button], [idea_bounty_button, bug_bounty_button], [main_menu_button]],
