...
async def async_send_message_to_users():
    ...
    message = (
        "🏆 <b>ПОЛЮВАННЯ ТРИВАЄ — І В НАС УЖЕ Є ПЕРЕМОЖЦІ!</b> 📢\n\n"
        "🙏 <b>Дякуємо всім, хто долучився!</b> Перші винагороди вже знайшли "
        "своїх власників — хтось знайшов баг, хтось запропонував ідею, "
        "яку ми взяли в роботу. Ви робите бота кращим для всіх нас.\n\n"
        "Нагадуємо, що конкурси не завершені — заробити може кожен:\n\n"
        ...
        "🚀 Наступним переможцем можете стати саме ви!"
    )
