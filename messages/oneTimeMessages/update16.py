...
async def async_send_message_to_users():
    ...
    message = (
        ...
        "📂 У розділі <b>Кадровий облік</b> додано новий звіт:\n"
        "📊 <b>«Звіт відпусток та лікарняних»</b>\n\n"
        "🔎 Звіт показує статистику використання "
        "<b>відпусток</b> 🌴 та <b>лікарняних</b> 🏥 за рік 📅\n\n"
        "🚀 Спробуйте вже зараз!"
    )
