...
def main():
    ...
    scheduler.add_job(run_periodic_check, 'interval', minutes=30)
    scheduler.add_job(run_periodic_sync, 'interval', minutes=60)
    scheduler.add_job(schedule_monthly_reminder, 'interval', weeks=4)
    scheduler.start()
