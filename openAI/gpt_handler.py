...
def get_gpt_response(user_input, user_id, employee_name):
    ...
    - 💼 Розрахунковий лист: Інформація по нарахуванню та виплаті ЗП, премій, бонусів за обраний місяць.
    - 📉 Дебіторська заборгованість: Поточна дебіторська заборгованість працівника.
    ...
    try:
        ...
        if recommended_command:
            gpt_response += f"\n\nℹ️ **Для цього у боті є вбудована функція!** Використайте команду: `{recommended_command}`."
