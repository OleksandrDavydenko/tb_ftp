...
def get_gpt_response(user_input, user_id, employee_name, message_id):
    ...
    messages = [
        {"role": "system", "content": "Ти - корпоративний фінансовий помічник у Telegram-боті. Відповідай лише на питання, що стосуються облікової політики, корпоративної довідкової інформації та функціоналу бота. Якщо питання виходить за ці рамки, відповідай ввічливо, що ти можеш допомогти."},
