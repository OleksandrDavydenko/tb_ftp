...
def get_gpt_response(user_input, user_id, employee_name, message_id):
    ...
    messages = [
        ...
        {"role": "system", "content": f"""
         ...
         Рекомендуй скористатись функціями бота, якщо в запитаннях прослідковується зв'язок з ними:
        ...
        🔹 **Запит користувача**:
        "{user_input}"
        ⚠️ Відповідаючи на запитання врахуй що застосовується parse_mode="HTML"
        """}
    ]
