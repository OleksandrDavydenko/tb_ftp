...
def get_gpt_response(user_input, user_id, employee_name, message_id):
    ...
    messages = [
        {"role": "system", "content": "Ти - корпоративний фінансовий помічник у Telegram-боті. Відповідай лише на питання, що стосуються облікової політики, корпоративних фінансів та функціоналу бота. Якщо питання виходить за ці рамки, відповідай ввічливо, що ти можеш допомогти лише у фінансових та корпоративних питаннях. Але будь вічливим та відповідай природньо. Якщо запитання стосовно того як справи представся та побажай гарного настрою."},
        ...
        - ℹ️ Інформація:
            - 💱 Курс валют: Актуальний курс валют (готівковий). (Інший курс валют не рекомендуй використовувавти. На сьогодні актуальний готівковий курс можна дізнатись в боті.)
