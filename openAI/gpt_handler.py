...
KNOWN_COMMANDS = {
    ...
    "/salary": "💼 Розрахунковий лист",
    "/analytics": "📊 Аналітика",
    "/info": "ℹ️ Інформація",
    "Головне меню": "Повертає на головне меню",
    "ℹ️ Інформація": "Розділ головного меню",
    "📊 Аналітика": "Персональна статистика користувача за визначений період",
    "💼 Розрахунковий лист": "Інформація по нарахуванню та виплаті ЗП, премій, бонусів",
    "📉 Дебіторська заборгованість": "Поточна дебіторська заборгованість працівника",
    "💱 Курс валют": "Актуальний курс валют",
    "Перевірка девальвації": "Порівняння курсу НБУ на дату виставлення рахунку з поточним курсом",
    "Аналітика за місяць": "Перегляд аналітики за місяць",
    "Аналітика за рік": "Перегляд аналітики за рік",
    "Протермінована дебіторська заборгованість": "Перегляд протермінованої дебіторської заборгованості",
}
...
def get_gpt_response(user_input, user_id, employee_name):
    ...
    - 📊 Аналітика: Персональна статистика користувача за визначений період (дохід, валовий прибуток, маржинальність, кількість угод).
    ...
    🔹 **Приклади можливих запитів користувача**:
    - "Коли буде виплата зарплати?"
    - "Яка моя дебіторська заборгованість?"
    - "Як переглянути мою аналітику за минулий рік?"

    📌 **Важлива інформація щодо виплат згідно з обліковою політикою**:
    - **Аванс** виплачується **до 20 числа** за фактично відпрацьований час.
    - **Основна частина зарплати** виплачується **не пізніше 7-го числа** наступного місяця.
    - **Неофіційна частина** виплачується **протягом трьох днів** після основної виплати.
    - **Премії та бонуси** нараховуються за підсумками закритого періоду і виплачуються **не пізніше 23-го числа наступного місяця**.
