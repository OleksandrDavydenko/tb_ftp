...
def get_gpt_response(user_input, user_id, employee_name, message_id):
    ...
    messages = [
        ...
        {"role": "system", "content": f"""
            Ти повинен відповідати у форматі HTML для Telegram. Уникай використання Markdown.
            ...
            ⚠️ Відповідай виключно у HTML. Наприклад:
            <b>Жирний текст</b>, <i>курсив</i>, <a href="https://example.com">посилання</a>.
        """}
    ]
